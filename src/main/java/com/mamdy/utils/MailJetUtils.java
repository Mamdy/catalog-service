...
public class MailJetUtils {
     ...
     * @param numOrder         le numéro de la commande
                        ...
                        .put(new JSONObject()
                                ...
                                .put(Emailv31.Message.HTMLPART,
                                        "<img src=\"https://xt96z.mjt.lu/tplimg/xt96z/b/05890/6xmo3.jpeg\" alt=\"logo\" width=\"30\" height=\"30\" class=\"d-inline-block align-top\">"+
                                               "<span style=\"font-size: 25px; color:red\">GN224-LOUMOSTORE</span>"
                                                + "<br>" + "<br>"+ "<br>" +
                                        "<p style=\"font-size:16px; font-familly:'proxima-nova';\">"  + body +  "<br>\n" + "<br>\n" +
                                        "Votre Commande numéro: " + numOrder + " a été validée." + "<br>" + "<br>" +
                                         "Elle sera traitée dans les plus bref delais." +"<br>" + "<br>" +
                                         "Vous recevrez un e-mail et un sms lorsque votre commande  sera expédiée." +"<br>" + "<br>" + "<br>" +
                                        "<a href=\"http://localhost:4200/followorder/\" style =\" display:inline-block;text-align:center; line-height:44px; text-decoration:none; color:white; width:300px; height: 15px; font-weight:bold; font-size:16px; background-color: rgba(24, 164, 189, 0.979); font-familly:'proxima-nova'; padding: 10px 100px; border-radius: 25px; margin-left: 315px;\">Suivre ma commande</a></p>" +
                                        "<br>"+ "<br>"+
                                        "<br>"+"Nous vous remercions de votre confiance." +"<br>" + "<br>"+ "<br>" + "<br>"+
                                        "L'équipe GN224-LOUMOSTORE SUPPORT" + "<br>" +
